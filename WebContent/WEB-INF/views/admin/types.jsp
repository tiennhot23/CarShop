            ...
            <div class="row">
               ...
               <div class="col-sm-3 login-section-wrapper">
              	  ...
              	  <div class="container mt-3">
                     <div class="row">
                        <form:form action="admin/types/" class="row g-3" modelAttribute="filter_type">
                           <div class="col-12">
                        ...
                        <div >
							<a href="admin/types/?clear=1"><button type="submit" class="btn badge badge-info">Clear filter</button></a>
						</div>
                     </div>
                  </div>
                  ...
                  <form:form action="admin/types/" method="post" modelAttribute="type" enctype="multipart/form-data">
                     ...
                     <div class="modal-footer">
                     	<div class="row">
                     	<a href="admin/types/?btnCancel" class="btn">Cancel</a>
               ...
               <c:url value="admin/types/" var="pagedLink">
                           ...
                           <div class="grid-margin stretch-card">
                              <div class="card">
                                 <div class="card-body">
                                    ...
                                    <p class="card-description"> All type in shop </p>
